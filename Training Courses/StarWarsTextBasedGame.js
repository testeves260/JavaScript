...
This game is fully working. However, the skills are pre-setted once there is a engine limitation. 
...
starDestroyer.addQuestion({ //Round 1 - Player Attack/CounterAttack
  ...
  options: ['[Attack]', '[Counter]','[Run Away]'], //TODO: Add a defend mode...
  action: function(answer) {
    lastRoundDamage = darkLord.attacks.attack1.damage;
...
starDestroyer.addQuestion({
  ...
  options: ['[Attack]', '[Counter]', '[' + jedi.attacks.skill1.name + ']', '[' + jedi.attacks.skill2.name + ']', '[Run Away]'],
  action: function(answer) {
...
starDestroyer.addQuestion({
  ...
  options: ['[Attack]', '[Counter]', '[' + jedi.learntSkills[0] + ']', '[' + jedi.learntSkills[1] + ']', '[Run Away]'],
  action: function(answer) {
    lastRoundDamage = darkLord.attacks.attack1.damage;
